...
final class Outfits
{
	...
	static final List<OutfitPiece> FARMERS = List.of(
		new OutfitPiece("Strawhat", Set.of(
			13646, 13647)),
		new OutfitPiece("Jacket / shirt", Set.of(
			13642, 13643)),
		new OutfitPiece("Boro trousers", Set.of(
			13640, 13641)),
		new OutfitPiece("Boots", Set.of(
			13644, 13645))
	);
